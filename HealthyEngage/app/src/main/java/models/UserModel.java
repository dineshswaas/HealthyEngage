...
public class UserModel<T> implements Serializable {
    String id,first_name,last_name,temp_password,email,mobile_no,gender,dob,
            is_mobile_verified,is_active,designation,address,profile_image_url,
            created_at,updated_at,country_code,realm,username,emailVerified,organisation_id;
